...
func verifySignature(in container: ReceiptContainer, rootCertificate name: String, bundle: Bundle) -> SignatureVerificationResult {
    ...
    let signatureResult = load(rootCertificateWith: name, bundle: bundle)
    return signatureResult
}


private func load(rootCertificateWith name: String, bundle: Bundle) -> SignatureVerificationResult {
    guard
